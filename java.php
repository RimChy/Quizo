...
if(isset($_POST['submit'])){
	...
	for($i=1;$i<16;$i++){
				...
				$stmt=$pdo->prepare('Select * from question_java where id=:qid');
				$stmt->execute(array(
				':qid'=>$i
				));
...
<html>
	...
	<body>
	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
		...
		<div class="container">
		<h1>Good Luck <?=htmlentities($_SESSION['name'])?> for your Java quiz</h1>
		<h3>15 Questions</h3>
		<div class="card border-primary mb-3 mx-auto text-left" style="width:50%;">;
		 ...
		 <?php
			...
			$stmt1=$pdo->prepare('Select * from ans_java where question_id=:qid');
				$stmt1->execute(array(
				':qid'=>$i
				));
